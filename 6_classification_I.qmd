...
Image classification has a vast array of use cases as mentioned previously, however lets look a few examples to compare pixel based approaches to object based.
